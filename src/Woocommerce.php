...
class Woocommerce implements PluginService
{
    ...
    function tlms_processExistingCustomer($order_id)
    {
 //tlms_recordLog('enter_woocommerce_checkout_order_processed');
    ...
    function tlms_woocommerce_payment_complete($order_id)
    {
 //tlms_recordLog('enter_woocommerce_payment_complete');
        $order_id = (new TLMSPositiveInteger($order_id))->getValue();
        $enroll_user_to_courses = get_option('tlms-enroll-user-to-courses');
    ...
    function tlms_processWooComOrder($order_id)
    {
 //tlms_recordLog('enter_woocommerce_order_status_completed');
        $order_id = (new TLMSPositiveInteger($order_id))->getValue();
        $enroll_user_to_courses = get_option('tlms-enroll-user-to-courses');
